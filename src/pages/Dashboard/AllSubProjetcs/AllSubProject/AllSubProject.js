    ...
    <div className={styles.container}>
      ...
      <div className={styles.top}>
        <div className={styles.topLeft}>
          ...
          <button
            onClick={() =>
              fetchTypeViceJobs(`/api/v1/subjobs?isCompleted=incomplete`)
            }
            style={{
          ...
          <button
            onClick={() =>
              fetchTypeViceJobs(`/api/v1/subjobs?isCompleted=complete`)
            }
            style={{
            ...
            <tbody className={styles.gfg}>
              {allJobs?.map((jobs, id) => (
                <tr key={jobs._id} className={styles.table__row}>
                  ...
                  <td>{jobs?.job?.projectName}</td>
                  <td>{jobs?.subJobName}</td>
